...
public class New
{
    ...
    private static void initialiseGUI() throws IOException
    {
        TableView<Contacts> table = new TableView<Contacts>();
        ...
        colMobilePhone.setCellValueFactory(
                        new PropertyValueFactory<Contacts, String>("Mobile Phone"));

        TableColumn <Contacts, String>colAddress1 = new TableColumn("Address 1");
        colAddress1.setMinWidth(60);
        colAddress1.setCellValueFactory(
                    new PropertyValueFactory<Contacts, String>("Address 1"));
        ...
        colAddress2.setCellValueFactory(
                    new PropertyValueFactory<Contacts, String>("Address 2"));
        ...
        colTownOrCity.setCellValueFactory(
                      new PropertyValueFactory<Contacts, String>("Town/City"));
    ...
    private static void getDataFromTextFile(TableView<Contacts> table) throws IOException{
